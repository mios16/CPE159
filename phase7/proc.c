...
void ShellProc()
{
	...
	while(1)	//forever loop:
	{
		...
		while(1)
		{
			...
			if(MyStrcmp(my_msg.data,"end", MyStrlen("end")) || MyStrcmp(my_msg.data, "000", MyStrlen("000")))
			{
			...
			if(MyStrcmp(my_msg.data,"dir", MyStrlen("dir")) || MyStrcmp(my_msg.data, "111", MyStrlen("111")))
			{
				DirSub(my_msg.data, FileServicePid);
				continue;
			}
			if(MyStrcmp(my_msg.data,"cat", MyStrlen("cat")) || MyStrcmp(my_msg.data, "222", MyStrlen("222")))
			{
