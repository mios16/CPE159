...
void InitKernelData() 
{
	...
	//phase 3
	product_count = 0; //set product_count to 0 (ProducerProc/ConsumerProc will incr/decr)
}
...
{ 				// learned from timer lab, remember to modify main.h
	...
	//Phase 2	
	SetEntry(48, GetPidEntry);	//add 2 new IDT entries.
	SetEntry(49, SleepEntry);	//add 2 new IDT entries.
